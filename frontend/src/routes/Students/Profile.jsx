...
export default function UserProfileDashboard() {
  ...
  return (
    <div className="p-6 w-full min-h-screen bg-gray-900 text-white flex justify-center items-center relative">
      {/* Back Button */}
      <button onClick={() => window.history.back()} className="absolute top-4 left-4 bg-gray-600 px-4 py-2 rounded text-white hover:bg-gray-700 cursor-pointer">
        Back
      </button>
      ...
      <div className="w-full max-w-4xl bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col md:flex-row">
        ...
        <div className="md:w-2/3 w-full pl-0 md:pl-6 mt-6 md:mt-0">
          ...
          <button onClick={() => setIsEditing(!isEditing)} className="mt-4 bg-blue-600 px-4 py-2 rounded text-white hover:bg-blue-700 w-full md:w-auto cursor-pointer">
            {isEditing ? "Save" : "Edit"}
          </button>
        </div>
      </div>
