...
import { DataCard, ProfileCard } from "../DashBoardComp/Cards.jsx";
import { Dropdown3 } from "../DashBoardComp/Dropdown.jsx";
        ...
        <>
            <div className='flex w-full'>
                <div className='w-full pl-[4%] pr-[2%] bg-stubgdark'>
                    <div className='h-[60px] sticky md:relative z-30 bg-stubgdark flex justify-end gap-x-4 items-center px-1 border-b-[1px] border-gray-500'>
                        {/* <Dropdown3 bgc="bg-stugreen" text="Resolved" text2="Unresolved" hbgc="hover:bg-stugreen/80"></Dropdown3> */}
                        <Dropdown3 bgc="bg-stured" text="Newest" text2="Oldest" hbgc="hover:bg-[#F41624]/85"></Dropdown3>
                        <Dropdown3 bgc="bg-stured" text="Most upvoted" text2="Most Downvoted" hbgc="hover:bg-[#F41624]/85"></Dropdown3>
                    </div>
                ...
                <div className='fixed z-20 bottom-[30px] right-[30px] lg:right-[200px] flex items-center gap-x-2 lg:gap-x-4'>
                    <div className='flex items-center bg-btnblue/70 hover:bg-btnblue/50 backdrop-blur-sm rounded-md p-1 cursor-pointer'>
